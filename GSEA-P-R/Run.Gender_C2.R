...
#
# R script to run GSEA Analysis of the Gender vs C2 example (cut and paste into R console)
...
GSEA(                                                                      # Input/Output Files :-------------------------------------------
 ...
 output.directory      = "d:/CGP2005/GSEA/GSEA-P-R/Gender_C2/",            # Directory where to store output and results (default: "")
#  Program parameters :----------------------------------------------------------------------------------------------------------------------------
 doc.string            = "Gender_C2",     # Documentation string used as a prefix to name result files (default: "GSEA.analysis")
...
GSEA.Analyze.Sets(
   directory           = "d:/CGP2005/GSEA/GSEA-P-R/Gender_C2/",        # Directory where to store output and results (default: "")

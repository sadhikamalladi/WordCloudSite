...
#
# R script to run GSEA Analysis of the Michigan ouctome example (cut and paste into R console)
...
GSEA(                                                                              # Input/Output Files :-------------------------------------------
 input.ds =  "d:/CGP2005/GSEA/GSEA-P-R/Datasets/Lung_Mich_maxed_common_Mich_Bost.gct",  # Input gene expression Affy dataset file in RES or GCT format
 input.cls = "d:/CGP2005/GSEA/GSEA-P-R/Datasets/Lung_Michigan.cls",                     # Input class vector (phenotype) file in CLS format
 gs.db =     "d:/CGP2005/GSEA/GSEA-P-R/GeneSetDatabases/Lung_Boston_poor_outcome.gmt",  # Gene set database in GMT format
 output.directory      = "d:/CGP2005/GSEA/GSEA-P-R/Lung_Michigan_outcome/",             # Directory where to store output and results (default: "")
#  Program parameters :----------------------------------------------------------------------------------------------------------------------------
 doc.string            = "Lung_Michigan_Boston_poor_outcome", # Documentation string used as a prefix to name result files (default: "GSEA.analysis")

...
#
# R script to run GSEA Analysis of the Lung Boston vs C2 example (cut and paste into R console)
...
GSEA(                                                                     # Input/Output Files :-------------------------------------------
 input.ds =  "d:/CGP2005/GSEA/GSEA-P-R/Datasets/Lung_Boston.gct",         # Input gene expression Affy dataset file in RES or GCT format
 ...
 output.directory      = "d:/CGP2005/GSEA/GSEA-P-R/Lung_Boston_C2/",      # Directory where to store output and results (default: "")
#  Program parameters :----------------------------------------------------------------------------------------------------------------------------
 doc.string            = "Lung_Boston_C2", # Documentation string used as a prefix to name result files (default: "GSEA.analysis")
...
GSEA.Analyze.Sets(
   directory           = "d:/CGP2005/GSEA/GSEA-P-R/Lung_Boston_C2/",        # Directory where to store output and results (default: "")

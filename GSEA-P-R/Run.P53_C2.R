...
GSEA(                                                                     # Input/Output Files :-------------------------------------------
 input.ds =  "d:/CGP2005/GSEA/GSEA-P-R/Datasets/P53.gct",                 # Input gene expression Affy dataset file in RES or GCT format
 input.cls = "d:/CGP2005/GSEA/GSEA-P-R/Datasets/P53.cls",                 # Input class vector (phenotype) file in CLS format
 gs.db =     "d:/CGP2005/GSEA/GSEA-P-R/GeneSetDatabases/C2.gmt",          # Gene set database in GMT format
 output.directory      = "d:/CGP2005/GSEA/GSEA-P-R/P53_C2/",              # Directory where to store output and results (default: "")
#  Program parameters :-------------------------------------------------------------------------------------------------------------------------

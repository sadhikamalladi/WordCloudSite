...
#
# R script to run GSEA Analysis of the Lung Stanford vs C2 example (cut and paste into R console)
...
GSEA(                                                                           # Input/Output Files :-------------------------------------------
 input.ds =  "d:/CGP2005/GSEA/GSEA-P-R/Datasets/Lung_Stanford.gct",         # Input gene expression Affy dataset file in RES or GCT format
 input.cls = "d:/CGP2005/GSEA/GSEA-P-R/Datasets/Lung_Stanford.cls",         # Input class vector (phenotype) file in CLS format
 gs.db =     "d:/CGP2005/GSEA/GSEA-P-R/GeneSetDatabases/C2.gmt",          # Gene set database in GMT format
 output.directory      = "d:/CGP2005/GSEA/GSEA-P-R/Lung_Stanford_C2/",      # Directory where to store output and results (default: "")
#  Program parameters :----------------------------------------------------------------------------------------------------------------------------
 doc.string            = "Lung_Stanford_C2", # Documentation string used as a prefix to name result files (default: "GSEA.analysis")
...
GSEA.Analyze.Sets(
   directory           = "d:/CGP2005/GSEA/GSEA-P-R/Lung_Stanford_C2/",        # Directory where to store output and results (default: "")
